...
##creating and adding labels to the stones end
        ...
        #bl_stone_label31=Label()
        #bl_stone_sctr31.add_widget(bl_stone_label31)
        #bl_stone_sctr31.bind(pos= lambda a,b: print(bl_stone_sctr31.pos))
        #bl_stone_sctr31.bind(pos= lambda a,b: setattr(bl_stone_label31, 'text', str(bl_stone_sctr31.pos)))
