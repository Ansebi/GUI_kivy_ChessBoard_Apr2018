...
do_scale_switch=True #RESIZE STONES
...
for chess_piece in chess_pieces:
    for stone_n in range(number_of_stones):
        ...
        pos=(20+stone_counter*stones_stack_step,20),auto_bring_to_front=False, do_scale=do_scale_switch)""" %(chess_piece,stone_n))
        exec("""wh_%s_sctr%d=Scatter(
        size_hint=(stone_size_hint,stone_size_hint),
        pos=(Window.width-90-stone_counter*stones_stack_step,20),auto_bring_to_front=False, do_scale=do_scale_switch)""" %(chess_piece,stone_n))
...
#adding labels and images to the stones end
        ...
        refresh_btn.bind(on_press=return_bl_stones)
        refresh_btn.bind(on_press=return_wh_stones)
        #refresh_btn.bind(on_press=return_rd_stones)
